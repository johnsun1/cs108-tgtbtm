...
//Set beast event flag to true
global.beast_event = true;
...
//Check that players have won or lost their battles, and that they still have HP
    if (global.p1_combat == 1 && global.p1_health > 0) { 
        global.p1_health += 2; global.p1_rep += 3; 
    } else {
        global.p1_health -= abs(global.p1_roll - global.p1_opfor_roll);
    }
    
    if (global.p2_combat == 2 && global.p2_health > 0) { 
        global.p2_health += 2; global.p2_rep += 3; 
    } else {
        global.p2_health -= abs(global.p2_roll - global.p2_opfor_roll);
    }
    
    if (global.p3_combat == 3 && global.p3_health > 0) {
...
//Wild Bear
    ...
    global.p2_health -= 2;
    global.p3_health -= 2;
} else if (global.drawn_monster_card = spr_monster_3) {
    if (global.p1_combat == 1 && global.p1_health > 0) { 
        global.p1_attack += 10; global.p1_rep += 6; 
    } else {
        global.p1_health -= abs(global.p1_roll - global.p1_opfor_roll);
    }

    if (global.p2_combat == 1 && global.p2_health > 0) { 
        global.p2_attack += 10; global.p2_rep += 6; 
    } else {
        global.p2_health -= abs(global.p2_roll - global.p2_opfor_roll);
    }
    
    if (global.p3_combat == 1 && global.p3_health > 0) { 
        global.p3_attack += 10; global.p3_rep += 6; 
    } else {
        global.p3_health -= abs(global.p3_roll - global.p3_opfor_roll);
    }}
